...
print("Le migrant se trouve sur ("+str(myMigrant.current_Cell.x)+","+str(myMigrant.current_Cell.y)+")")
print("Il souhaite rejoindre la maison ("+str(myMigrant.Walkers_building.x)+","+str(myMigrant.Walkers_building.y)+")")
